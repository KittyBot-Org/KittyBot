...
public class OldSQL{
	...
	private static final Logger LOG = LoggerFactory.getLogger(OldSQL.class);

	private final Connection conn;

	public OldSQL(String host, String port, String user, String password, String database) throws SQLException{
		this.conn = DriverManager.getConnection("jdbc:postgresql://" + host + ":" + port + "/" + database, user, password);
	}

	public static OldSQL newInstance(String host, String port, String user, String password, String database) throws SQLException{
		return new OldSQL(host, port, user, password, database);
	}
