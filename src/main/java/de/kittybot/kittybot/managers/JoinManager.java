		...
		guild.retrieveAuditLogs().type(ActionType.BOT_ADD).limit(1).cache(false).queue(entries -> {
			...
			var embed = new EmbedBuilder()
					...
					.setDescription(
							...
							+ "To report bugs/suggest features either join my " + MessageUtils.maskLink("Support Server", Config.SUPPORT_GUILD_INVITE_URL) + ", add me on Discord ``toπ#3141`` or message me on [Twitter](https://twitter.com/TopiSenpai)")
