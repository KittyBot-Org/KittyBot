...
public class HastebinCommand extends RunCommand{
	...
	public void run(Options options, CommandContext ctx){
		if(ctx instanceof GuildCommandContext && !((GuildCommandContext) ctx).getSelfMember().hasPermission(((GuildCommandContext) ctx).getChannel(), Permission.VIEW_CHANNEL, Permission.MESSAGE_HISTORY)){
