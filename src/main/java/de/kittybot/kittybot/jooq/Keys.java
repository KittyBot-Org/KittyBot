...
public class Keys {
    ...
    public static final UniqueKey<GuildTagsRecord> GUILD_TAGS_MEMBER_ID_KEY = Internal.createUniqueKey(GuildTags.GUILD_TAGS, DSL.name("guild_tags_member_id_key"), new TableField[] { GuildTags.GUILD_TAGS.MEMBER_ID }, true);
    ...
    public static final UniqueKey<MemberRolesRecord> MEMBER_ROLES_MEMBER_ID_KEY = Internal.createUniqueKey(MemberRoles.MEMBER_ROLES, DSL.name("member_roles_member_id_key"), new TableField[] { MemberRoles.MEMBER_ROLES.MEMBER_ID }, true);
    ...
    public static final UniqueKey<MemberRolesRecord> MEMBER_ROLES_ROLE_ID_KEY = Internal.createUniqueKey(MemberRoles.MEMBER_ROLES, DSL.name("member_roles_role_id_key"), new TableField[] { MemberRoles.MEMBER_ROLES.ROLE_ID }, true);
    public static final UniqueKey<MembersRecord> MEMBERS_GUILD_ID_KEY = Internal.createUniqueKey(Members.MEMBERS, DSL.name("members_guild_id_key"), new TableField[] { Members.MEMBERS.GUILD_ID }, true);
    ...
    public static final UniqueKey<MembersRecord> MEMBERS_USER_ID_KEY = Internal.createUniqueKey(Members.MEMBERS, DSL.name("members_user_id_key"), new TableField[] { Members.MEMBERS.USER_ID }, true);
    ...
    public static final UniqueKey<UserStatisticsRecord> USER_STATISTICS_MEMBER_ID_KEY = Internal.createUniqueKey(UserStatistics.USER_STATISTICS, DSL.name("user_statistics_member_id_key"), new TableField[] { UserStatistics.USER_STATISTICS.MEMBER_ID }, true);
    ...
    public static final ForeignKey<BotIgnoredMembersRecord, MembersRecord> BOT_IGNORED_MEMBERS__BOT_IGNORED_MEMBERS_MEMBER_ID_FKEY = Internal.createForeignKey(BotIgnoredMembers.BOT_IGNORED_MEMBERS, DSL.name("bot_ignored_members_member_id_fkey"), new TableField[] { BotIgnoredMembers.BOT_IGNORED_MEMBERS.MEMBER_ID }, Keys.MEMBERS_PKEY, new TableField[] { Members.MEMBERS.ID }, true);
    ...
    public static final ForeignKey<GuildTagsRecord, MembersRecord> GUILD_TAGS__GUILD_TAGS_MEMBER_ID_FKEY = Internal.createForeignKey(GuildTags.GUILD_TAGS, DSL.name("guild_tags_member_id_fkey"), new TableField[] { GuildTags.GUILD_TAGS.MEMBER_ID }, Keys.MEMBERS_PKEY, new TableField[] { Members.MEMBERS.ID }, true);
    public static final ForeignKey<MemberRolesRecord, MembersRecord> MEMBER_ROLES__MEMBER_ROLES_MEMBER_ID_FKEY = Internal.createForeignKey(MemberRoles.MEMBER_ROLES, DSL.name("member_roles_member_id_fkey"), new TableField[] { MemberRoles.MEMBER_ROLES.MEMBER_ID }, Keys.MEMBERS_PKEY, new TableField[] { Members.MEMBERS.ID }, true);
    public static final ForeignKey<MembersRecord, GuildsRecord> MEMBERS__MEMBERS_GUILD_ID_FKEY = Internal.createForeignKey(Members.MEMBERS, DSL.name("members_guild_id_fkey"), new TableField[] { Members.MEMBERS.GUILD_ID }, Keys.GUILDS_PKEY, new TableField[] { Guilds.GUILDS.ID }, true);
    public static final ForeignKey<MembersRecord, UsersRecord> MEMBERS__MEMBERS_USER_ID_FKEY = Internal.createForeignKey(Members.MEMBERS, DSL.name("members_user_id_fkey"), new TableField[] { Members.MEMBERS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.ID }, true);
    public static final ForeignKey<NotificationsRecord, MembersRecord> NOTIFICATIONS__NOTIFICATIONS_MEMBER_ID_FKEY = Internal.createForeignKey(Notifications.NOTIFICATIONS, DSL.name("notifications_member_id_fkey"), new TableField[] { Notifications.NOTIFICATIONS.MEMBER_ID }, Keys.MEMBERS_PKEY, new TableField[] { Members.MEMBERS.ID }, true);
    public static final ForeignKey<ReactiveMessagesRecord, MembersRecord> REACTIVE_MESSAGES__REACTIVE_MESSAGES_MEMBER_ID_FKEY = Internal.createForeignKey(ReactiveMessages.REACTIVE_MESSAGES, DSL.name("reactive_messages_member_id_fkey"), new TableField[] { ReactiveMessages.REACTIVE_MESSAGES.MEMBER_ID }, Keys.MEMBERS_PKEY, new TableField[] { Members.MEMBERS.ID }, true);
    public static final ForeignKey<RequestsRecord, MembersRecord> REQUESTS__REQUESTS_MEMBER_ID_FKEY = Internal.createForeignKey(Requests.REQUESTS, DSL.name("requests_member_id_fkey"), new TableField[] { Requests.REQUESTS.MEMBER_ID }, Keys.MEMBERS_PKEY, new TableField[] { Members.MEMBERS.ID }, true);
    ...
    public static final ForeignKey<UserStatisticsRecord, MembersRecord> USER_STATISTICS__USER_STATISTICS_MEMBER_ID_FKEY = Internal.createForeignKey(UserStatistics.USER_STATISTICS, DSL.name("user_statistics_member_id_fkey"), new TableField[] { UserStatistics.USER_STATISTICS.MEMBER_ID }, Keys.MEMBERS_PKEY, new TableField[] { Members.MEMBERS.ID }, true);
}
