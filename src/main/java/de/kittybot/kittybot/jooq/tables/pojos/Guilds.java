...
public class Guilds implements Serializable {
    ...
    private final Long         streamAnnouncementChannelId;
    private final String       streamAnnouncementMessage;
    private final Boolean      nsfwEnabled;
    private final Long         inactiveRoleId;
    private final YearToSecond inactiveDuration;
    private final Boolean      inactiveRoleEnabled;
    ...
    public Guilds(Guilds value) {
        ...
        this.streamAnnouncementChannelId = value.streamAnnouncementChannelId;
        this.streamAnnouncementMessage = value.streamAnnouncementMessage;
        this.nsfwEnabled = value.nsfwEnabled;
        this.inactiveRoleId = value.inactiveRoleId;
        this.inactiveDuration = value.inactiveDuration;
        this.inactiveRoleEnabled = value.inactiveRoleEnabled;
        this.djRoleId = value.djRoleId;
        this.snipesEnabled = value.snipesEnabled;
    }
    ...
    public Guilds(
        ...
        Long         streamAnnouncementChannelId,
        String       streamAnnouncementMessage,
        Boolean      nsfwEnabled,
        Long         inactiveRoleId,
        YearToSecond inactiveDuration,
        Boolean      inactiveRoleEnabled,
        Long         djRoleId,
        ...
        this.inactiveRoleEnabled = inactiveRoleEnabled;
    ...
    public Boolean getInactiveRoleEnabled() {
        return this.inactiveRoleEnabled;
    }
    ...
    public String toString() {
        ...
        sb.append(", ").append(streamAnnouncementChannelId);
        sb.append(", ").append(streamAnnouncementMessage);
        sb.append(", ").append(nsfwEnabled);
        sb.append(", ").append(inactiveRoleId);
        sb.append(", ").append(inactiveDuration);
        sb.append(", ").append(inactiveRoleEnabled);
        sb.append(", ").append(djRoleId);
        sb.append(", ").append(snipesEnabled);
