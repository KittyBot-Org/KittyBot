...
public class RequestsRecord extends UpdatableRecordImpl<RequestsRecord> implements Record8<Long, Long, Long, String, String, Boolean, Boolean, LocalDateTime>{
	 ...
	 */
	public RequestsRecord(Long requestId, Long userId, Long guildId, String title, String body, Boolean answered, Boolean accepted, LocalDateTime creationTime){
		super(Requests.REQUESTS);
	...
	public Field<Long> field1(){
		return Requests.REQUESTS.REQUEST_ID;
	}
	...
	public Field<LocalDateTime> field8(){
		return Requests.REQUESTS.CREATION_TIME;
	}
	...
	/**
	 * Setter for <code>public.requests.request_id</code>.
	 */
	public RequestsRecord setRequestId(Long value){
		set(0, value);
		return this;
	}
	...
	/**
	 * Setter for <code>public.requests.creation_time</code>.
	 */
	public RequestsRecord setCreationTime(LocalDateTime value){
		set(7, value);
		return this;
	}
