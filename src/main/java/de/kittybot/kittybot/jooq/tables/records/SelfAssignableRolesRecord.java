...
public class SelfAssignableRolesRecord extends UpdatableRecordImpl<SelfAssignableRolesRecord> implements Record5<Long, Long, Long, Long, Long> {
    ...
    /**
     * Setter for <code>public.self_assignable_roles.id</code>.
     */
    public SelfAssignableRolesRecord setId(Long value) {
        set(0, value);
        return this;
    }
    ...
    public Field<Long> field1() {
        return SelfAssignableRoles.SELF_ASSIGNABLE_ROLES.ID;
    }
     ...
     */
    public SelfAssignableRolesRecord(Long id, Long groupId, Long guildId, Long roleId, Long emoteId) {
        super(SelfAssignableRoles.SELF_ASSIGNABLE_ROLES);
