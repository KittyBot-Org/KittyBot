...
public class SessionsRecord extends UpdatableRecordImpl<SessionsRecord> implements Record5<Long, Long, String, String, LocalDateTime> {
    ...
    @Override
    public SessionsRecord values(Long value1, Long value2, String value3, String value4, LocalDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SessionsRecord(Long id, Long userId, String accessToken, String refreshToken, LocalDateTime expiration) {
        super(Sessions.SESSIONS);
