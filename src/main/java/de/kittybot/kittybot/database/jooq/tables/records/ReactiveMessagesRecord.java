...
public class ReactiveMessagesRecord extends TableRecordImpl<ReactiveMessagesRecord> implements Record7<String, String, String, String, String, String, String> {
