...
public class Guilds extends TableImpl<GuildsRecord> {
     ...
     */
    public final TableField<GuildsRecord, String> GUILD_ID = createField(DSL.name("guild_id"), SQLDataType.VARCHAR(18).nullable(false), this, "");

    /**
     * The column <code>public.guilds.command_prefix</code>.
     */
    public final TableField<GuildsRecord, String> COMMAND_PREFIX = createField(DSL.name("command_prefix"), SQLDataType.VARCHAR(1).nullable(false), this, "");

    /**
     * The column <code>public.guilds.request_channel_id</code>.
     */
    public final TableField<GuildsRecord, String> REQUEST_CHANNEL_ID = createField(DSL.name("request_channel_id"), SQLDataType.VARCHAR(18).nullable(false), this, "");

    /**
     * The column <code>public.guilds.requests_enabled</code>.
     */
    public final TableField<GuildsRecord, Boolean> REQUESTS_ENABLED = createField(DSL.name("requests_enabled"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.guilds.announcement_channel_id</code>.
     */
    public final TableField<GuildsRecord, String> ANNOUNCEMENT_CHANNEL_ID = createField(DSL.name("announcement_channel_id"), SQLDataType.VARCHAR(18).nullable(false), this, "");

    /**
     * The column <code>public.guilds.join_messages</code>.
     */
    public final TableField<GuildsRecord, String> JOIN_MESSAGES = createField(DSL.name("join_messages"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.guilds.join_messages_enabled</code>.
     */
    public final TableField<GuildsRecord, Boolean> JOIN_MESSAGES_ENABLED = createField(DSL.name("join_messages_enabled"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.guilds.leave_messages</code>.
     */
    public final TableField<GuildsRecord, String> LEAVE_MESSAGES = createField(DSL.name("leave_messages"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.guilds.leave_messages_enabled</code>.
     */
    public final TableField<GuildsRecord, Boolean> LEAVE_MESSAGES_ENABLED = createField(DSL.name("leave_messages_enabled"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.guilds.boost_messages</code>.
     */
    public final TableField<GuildsRecord, String> BOOST_MESSAGES = createField(DSL.name("boost_messages"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.guilds.boost_messages_enabled</code>.
     */
    public final TableField<GuildsRecord, Boolean> BOOST_MESSAGES_ENABLED = createField(DSL.name("boost_messages_enabled"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.guilds.log_channel_id</code>.
     */
    public final TableField<GuildsRecord, String> LOG_CHANNEL_ID = createField(DSL.name("log_channel_id"), SQLDataType.VARCHAR(18).nullable(false), this, "");

    /**
     * The column <code>public.guilds.log_messages_enabled</code>.
     */
    public final TableField<GuildsRecord, Boolean> LOG_MESSAGES_ENABLED = createField(DSL.name("log_messages_enabled"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.guilds.nsfw_enabled</code>.
     */
    public final TableField<GuildsRecord, Boolean> NSFW_ENABLED = createField(DSL.name("nsfw_enabled"), SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.guilds.inactive_role_id</code>.
     */
    public final TableField<GuildsRecord, String> INACTIVE_ROLE_ID = createField(DSL.name("inactive_role_id"), SQLDataType.VARCHAR(18).nullable(false), this, "");
