...
public class UserStatisticsRecord extends TableRecordImpl<UserStatisticsRecord> implements Record9<String, String, Integer, Integer, Integer, Integer, Integer, Integer, String> {
