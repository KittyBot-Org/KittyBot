...
public class SelfAssignableRoleGroups extends TableImpl<SelfAssignableRoleGroupsRecord>{
	...
	private static final long serialVersionUID = -359794757;
	/**
	...
	/**
	 * The column <code>public.self_assignable_role_groups.only_one</code>.
	 */
	public final TableField<SelfAssignableRoleGroupsRecord, Boolean> ONLY_ONE = createField(DSL.name("only_one"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
