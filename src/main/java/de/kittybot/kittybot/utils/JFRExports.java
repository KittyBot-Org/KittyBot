...
public class JFRExports {
	...
	public static void register() {
		...
		}).withPeriod(PrometheusManager.UPDATE_PERIOD);
		...
		/*event(rs, "jdk.PhysicalMemory", e ->
				AsyncInfoMonitor.setMachineMemoryUsage(e.getLong("usedSize"), e.getLong("totalSize"))).withPeriod(PrometheusManager.UPDATE_PERIOD
		);*/
