...
public class StreamUsersRecord extends UpdatableRecordImpl<StreamUsersRecord> implements Record5<Long, Long, Long, String, Integer> {
    ...
    @Override
    public StreamUsersRecord values(Long value1, Long value2, Long value3, String value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StreamUsersRecord(Long id, Long guildId, Long userId, String userName, Integer streamType) {
        super(StreamUsers.STREAM_USERS);
