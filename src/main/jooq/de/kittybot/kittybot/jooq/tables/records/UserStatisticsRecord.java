...
public class UserStatisticsRecord extends UpdatableRecordImpl<UserStatisticsRecord> implements Record10<Long, Long, Long, Integer, Integer, Integer, Integer, Integer, Integer, LocalDateTime> {
     ...
     */
    public UserStatisticsRecord(Long id, Long guildId, Long userId, Integer xp, Integer level, Integer botCalls, Integer voiceTime, Integer messageCount, Integer emoteCount, LocalDateTime lastActive) {
        super(UserStatistics.USER_STATISTICS);
