...
public class GuildsRecord extends UpdatableRecordImpl<GuildsRecord> implements Record19<Long, Long, String, Boolean, String, Boolean, Long, Boolean, Long, Boolean, Long, String, Boolean, Long, YearToSecond, Boolean, Long, Boolean, Boolean> {
    ...
    /**
     * Setter for <code>public.guilds.role_saver_enabled</code>.
     */
    public GuildsRecord setRoleSaverEnabled(Boolean value) {
        set(18, value);
        return this;
    }

    /**
     * Getter for <code>public.guilds.role_saver_enabled</code>.
     */
    public Boolean getRoleSaverEnabled() {
    ...
    @Override
    public Row19<Long, Long, String, Boolean, String, Boolean, Long, Boolean, Long, Boolean, Long, String, Boolean, Long, YearToSecond, Boolean, Long, Boolean, Boolean> valuesRow() {
    ...
    public Field<Boolean> field19() {
        return Guilds.GUILDS.ROLE_SAVER_ENABLED;
    }
    ...
    public GuildsRecord value19(Boolean value) {
        setRoleSaverEnabled(value);
        return this;
    }

    @Override
    public GuildsRecord values(Long value1, Long value2, String value3, Boolean value4, String value5, Boolean value6, Long value7, Boolean value8, Long value9, Boolean value10, Long value11, String value12, Boolean value13, Long value14, YearToSecond value15, Boolean value16, Long value17, Boolean value18, Boolean value19) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public GuildsRecord(Long id, Long announcementChannelId, String joinMessage, Boolean joinMessagesEnabled, String leaveMessage, Boolean leaveMessagesEnabled, Long logChannelId, Boolean logMessagesEnabled, Long requestChannelId, Boolean requestsEnabled, Long streamAnnouncementChannelId, String streamAnnouncementMessage, Boolean nsfwEnabled, Long inactiveRoleId, YearToSecond inactiveDuration, Boolean inactiveRoleEnabled, Long djRoleId, Boolean snipesEnabled, Boolean roleSaverEnabled) {
        ...
        setRoleSaverEnabled(roleSaverEnabled);
    }
}
