...
public class Keys {
    ...
    public static final UniqueKey<MemberRolesRecord> MEMBER_ROLES_GUILD_ID_KEY = Internal.createUniqueKey(MemberRoles.MEMBER_ROLES, DSL.name("member_roles_guild_id_key"), new TableField[] { MemberRoles.MEMBER_ROLES.GUILD_ID }, true);
    ...
    public static final UniqueKey<MemberRolesRecord> MEMBER_ROLES_USER_ID_KEY = Internal.createUniqueKey(MemberRoles.MEMBER_ROLES, DSL.name("member_roles_user_id_key"), new TableField[] { MemberRoles.MEMBER_ROLES.USER_ID }, true);
