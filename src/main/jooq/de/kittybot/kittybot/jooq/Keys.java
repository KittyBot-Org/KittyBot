...
public class Keys {
    ...
    public static final UniqueKey<StreamUsersRecord> STREAM_USERS_GUILD_ID_USER_NAME_STREAM_TYPE_KEY = Internal.createUniqueKey(StreamUsers.STREAM_USERS, DSL.name("stream_users_guild_id_user_name_stream_type_key"), new TableField[] { StreamUsers.STREAM_USERS.GUILD_ID, StreamUsers.STREAM_USERS.USER_NAME, StreamUsers.STREAM_USERS.STREAM_TYPE }, true);
